...
>(({ className, ...props }, ref) => (
    <SheetPrimitive.Overlay
        className={cn(
            // "fixed inset-0 z-50 bg-background/10 backdrop-blur supports-[backdrop-filter]:bg-background/30 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
    ...
    "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-500 data-[state=open]:duration-500",
    {
        variants: {
            side: {
                ...
                right: "inset-y-0 right-0 h-full w-3/4  border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right md:max-w-3xl overflow-auto",
